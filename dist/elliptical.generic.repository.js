...
(function (root, factory) {
    ...
    function GenericRepository(model,fn){
        ...
        this.orderBy=function(result,prop,camelCaseSort){
            if(!camelCaseSort) camelCaseSort=this.camelCaseSort;
            var orderByIterator=[];
            orderByIterator.push(prop);
            return _sortAsc(result,orderByIterator,camelCaseSort);
        };

        this.orderByDesc=function(result,prop,camelCaseSort){
            if(!camelCaseSort) camelCaseSort=this.camelCaseSort;
            var orderByDescIterator=[];
            orderByDescIterator.push(prop);
            return _sortDesc(result,orderByDescIterator,camelCaseSort);
        };
